...
class GenArray1D implements Opcodes {
	...
	/**
	 * Instantiate GenArray1D
	 *  
	 * @param elementInterfaceClass, element type for Array
	 */
	public GenArray1D(Class<? extends Layout> elementInterfaceClass) {
	 ...
	 */
	public <E extends Layout, AE extends Array1D<E>>
	GenArray1D(Class<E> elementInterfaceClass, Class<AE> userDefinedArrayClass) {
	...
	public byte[] genBytecode() throws Exception {
		...
		}
		{
			...
			mv.visitMethodInsn(INVOKEVIRTUAL, arrayImplClassName, "put", "(JL" + elementInterfaceClassName + ";)V", itf);
			mv.visitInsn(RETURN);
			mv.visitMaxs(4, 4);
			mv.visitEnd();
		}
