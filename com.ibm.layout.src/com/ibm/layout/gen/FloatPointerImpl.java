 ...
 * Pointer Layout
 */
public class FloatPointerImpl extends LayoutTypeImpl implements FloatPointer {	
	public float lValue() {
		return UnsafeImplHelper.loadNativeFloat(this.location.getData(), this.location.getOffset());
	}
	...
	public String toString() {
		return "FloatPointer base: " + this.location.getData() + " offset: " + this.location.getOffset(); 
	}
	...
	@Override
	public FloatPointer atOffset(long offset) {
		FloatPointer newPointer = LayoutType.getPrimPointer(float.class);
