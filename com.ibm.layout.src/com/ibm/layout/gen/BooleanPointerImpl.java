 ...
 * Pointer Layout
 */
public class BooleanPointerImpl extends LayoutTypeImpl implements BooleanPointer {	
	public boolean lValue() {
		return UnsafeImplHelper.loadNativeBoolean(this.location.getData(), this.location.getOffset());
	}
	...
	public String toString() {
		return "BooleanPointer base: " + this.location.getData() + " offset: " + this.location.getOffset(); 
	}
	...
	public BooleanPointer atOffset(long offset) {
		BooleanPointer newPointer = LayoutType.getPrimPointer(boolean.class);
