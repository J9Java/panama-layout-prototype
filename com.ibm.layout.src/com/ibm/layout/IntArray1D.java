...
/**
 * 1D array of primitive int.
 */
public interface IntArray1D extends LayoutType {
	/**
	 ...
	 */
	public abstract void put(long index, int value);
	 ...
	 */
	public abstract IntArray1D range(long startIdx, long length);
