...
/**
 * 1D array of primitive double.
 */
public interface DoubleArray1D extends LayoutType {
	 ...
	 */
	public abstract double at(long index);
	 ...
	 */
	public abstract void put(long index, double value);
	 ...
	 */
	public abstract DoubleArray1D range(long startIdx, long length);
