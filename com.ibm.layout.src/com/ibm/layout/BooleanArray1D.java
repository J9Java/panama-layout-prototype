...
/**
 * 1D array of primitive boolean.
 */
public interface BooleanArray1D extends LayoutType {
	/**
	 ...
	 */
	public abstract void put(long index, boolean value);
	 ...
	 */
	public abstract BooleanArray1D range(long startIdx, long length);
