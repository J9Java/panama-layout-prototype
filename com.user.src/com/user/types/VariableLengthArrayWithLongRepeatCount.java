...
/* Generated by LD2J */
@LayoutDesc({"lengthOfArray:jlong:1","elements:ArrayElement[lengthOfArray]:0"})
public interface VariableLengthArrayWithLongRepeatCount extends Layout {

	interface EffectiveAddress {

		public LongPointer lengthOfArray();

		public Pointer<ArrayElement> elements();

	}

	public VariableLengthArrayWithLongRepeatCount.EffectiveAddress EA();
